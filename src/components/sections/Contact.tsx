            ...
            <div className="container mx-auto px-6 max-w-5xl">
                <div className="text-center mb-16 space-y-4">
                    ...
                    <h2 className="text-5xl md:text-6xl font-bold tracking-tight text-white mb-6">
                        Parliamo del <span className="text-primary glow-text">tuo progetto.</span>
                    </h2>
                ...
                <div className="bg-[#0a0a0a] rounded-3xl p-8 md:p-12 border border-white/5 relative overflow-hidden">

                    {/* User Type Selector */}
                    <div className="flex gap-4 mb-12 justify-center p-1.5 bg-black/50 border border-white/5 rounded-2xl w-fit mx-auto">
                        <button
                            type="button"
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    type="text"
                                    className="w-full bg-[#111] border border-white/5 rounded-lg px-4 py-4 text-white focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all"
                                />
                            </div>
                            <div className="space-y-2">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="space-y-2">
                                ...
                                <div className="flex bg-[#111] border border-white/5 rounded-lg overflow-hidden">
                                    <div className="px-4 py-4 bg-[#1a1a1a] text-gray-400 border-r border-white/5 flex items-center gap-2">
                                        🇮🇹 +39
                                    </div>
                                    <input
                                        name="telefono"
                        ...
                        {userType === "azienda" && (
                            <div className="space-y-2 animate-in fade-in slide-in-from-bottom-2 duration-300">
                                ...
                                <input
                                    ...
                                    className="w-full bg-[#111] border border-white/5 rounded-lg px-4 py-4 text-white focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all placeholder:text-gray-600"
                                />
                            </div>
                        )}
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                onChange={handleChange}
                                rows={6}
                                className="w-full bg-[#111] border border-white/5 rounded-lg px-4 py-4 text-white focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all resize-none"
                            ></textarea>
                        </div>
